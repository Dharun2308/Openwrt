...
local m = Map("uhttpd", translate("Arca-uHTTPd"),
	      translate(""))
...
o = ucs:taboption("general", Button, "remove_old", translate("Remove old certificate and key"),
		  translate("Arca-uHTTPd will generate a new self-signed certificate using the configuration shown below."))
o.inputstyle = "remove"
...
o = ucs:taboption("advanced", Flag, "ubus_cors", translate("Enable JSON-RPC"))
o.default = o.disabled
o.optional = true

o = ucs:taboption("advanced", Flag, "no_ubusauth", translate("Disable JSON-RPC "))
o.optional= true
o.default = o.disabled

o = ucs:taboption("advanced", Value, "script_timeout", translate("Maximum wait time "))
o.placeholder = 60
o.datatype = "uinteger"
o.optional = true
...
local s = m:section(TypedSection, "cert", translate("Arca-uHTTPd Self-signed Certificate Parameters"))
