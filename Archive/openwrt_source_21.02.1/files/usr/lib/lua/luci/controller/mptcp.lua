...
function index()
	entry({"admin", "network", "mptcp"}, alias("admin", "network", "mptcp", "settings"), _("Network Aggregation"))
	...
	entry({"admin", "network", "mptcp", "mptcp_check"}, template("mptcp/mptcp_check"), _("Arca Support Check"), 4).leaf = true
	entry({"admin", "network", "mptcp", "mptcp_check_trace"}, post("mptcp_check_trace")).leaf = true
	entry({"admin", "network", "mptcp", "mptcp_fullmesh"}, template("mptcp/mptcp_fullmesh"), _("Arca Fullmesh"), 5).leaf = true
	...
	entry({"admin", "network", "mptcp", "mptcp_monitor"}, template("mptcp/mptcp_monitor"), _("Network Monitoring"), 6).leaf = true
